...
module.exports = function (point1, distance, bearing, units) {
  ...
  var latitude2 = Math.asin(Math.sin(latitude1) * Math.cos(distance / R) +
      Math.cos(latitude1) * Math.sin(distance / R) * Math.cos(bearingRad));
  var longitude2 = longitude1 + Math.atan2(Math.sin(bearingRad) * Math.sin(distance / R) * Math.cos(latitude1),
